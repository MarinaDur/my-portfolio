                ...
                <StyledContainer>
                  <StyledParagraphContainer>
                    <PageTitle as="h3" $fontSize="clamp(2rem, 2vw, 3rem)">
                      I&apos;m Marina. I build with purpose, polish with
                      passion, and always keep the cat in the loop.
                    </PageTitle>
                    <Paragraph $fontSize="clamp(1.5rem, 1.3vw, 2.5rem)">
                      With a background in QA, a passion for thoughtful design,
                      and a love for building things that are both functional
                      and beautiful, I bring detail and intention into every
                      line of code.
                    </Paragraph>
                    <Paragraph $fontSize="clamp(1.5rem, 1.3vw, 2.5rem)">
                      ...
                      somewhere along the way, I realized I didn&apos;t just
                      want to test things — I wanted to build them.
                    </Paragraph>
                    <Paragraph $fontSize="clamp(1.5rem, 1.3vw, 2.5rem)">
                    ...
                    <Paragraph $fontSize="clamp(1.5rem, 1.3vw, 2.5rem)">
                      ...
                      always exploring ways to bring creative energy into code.
                      My portfolio is a space where I explore, experiment, and
                      push myself creatively — just how I like it.
                    </Paragraph>
                    <Paragraph $fontSize="clamp(1.5rem, 1.3vw, 2.5rem)">
